...
surrogate_models = ['ibafs','gbafs','pssvc']
...
log_scale_files = [
    ...
    'collected_gbafs_f1_d10.csv','collected_gbafs_f2_d10.csv','collected_gbafs_f4_d10.csv','collected_gbafs_f8_d10.csv','collected_gbafs_f13_d10.csv',

    'collected_gbafs_f1_d30.csv','collected_gbafs_f2_d30.csv','collected_gbafs_f8_d30.csv','collected_gbafs_f13_d30.csv',

    'collected_pssvc_f1_d10.csv','collected_pssvc_f2_d10.csv','collected_pssvc_f8_d10.csv','collected_pssvc_f13_d10.csv',

    'collected_pssvc_f8_d30.csv'
]
inset_files = [
    # ...インセットを追加するやつ
    ...
    'collected_gbafs_f1_d10.csv','collected_gbafs_f2_d10.csv','collected_gbafs_f4_d10.csv','collected_gbafs_f8_d10.csv','collected_gbafs_f13_d10.csv',
    'collected_gbafs_f8_d30.csv','collected_gbafs_f13_d30.csv',

    'collected_ibafs_f2_d30.csv','collected_ibafs_f8_d30.csv','collected_ibafs_f13_d30.csv','collected_ibafs_f15_d30.csv',

    'collected_pssvc_f1_d10.csv','collected_pssvc_f2_d10.csv','collected_pssvc_f8_d10.csv',
    'collected_pssvc_f1_d30.csv',
...
inset_ymax_files = {
    ...
    'collected_gbafs_f13_d10.csv': 1.625e3,
