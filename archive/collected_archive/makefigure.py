...
surrogate_models = ['changed_collected_data_new_ibrbf_changed']
...
log_scale_files = [
    ...
    'collected_data_ibbubble_f1_d10.csv','collected_data_ibbubble_f2_d10.csv', 'collected_data_ibbubble_f8_d10.csv', 'collected_data_ibbubble_f13_d10.csv',
]
inset_files = [
    ...
    'collected_data_ibbubble_f2_d10.csv', 'collected_data_ibbubble_f8_d10.csv', 'collected_data_ibbubble_f13_d10.csv',
]
